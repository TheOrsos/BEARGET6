    ...
    <div class="flex h-screen">
        ...
        <main class="flex-1 p-6 lg:p-10 overflow-y-auto">
            <header class="flex flex-wrap justify-between items-center gap-4 mb-8">
                ...
                <button onclick="openAddRecurringModal()" class="bg-primary-600 hover:bg-primary-700  font-semibold py-2 px-5 rounded-lg flex items-center transition-colors shadow-lg hover:shadow-primary-500/50">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                    Aggiungi
                </button>
            </header>

            <div class="bg-gray-800 rounded-2xl p-2 flex flex-col" style="height: calc(100vh - 10rem);">
                <div class="overflow-auto">
                    <table class="w-full text-left">
                        ...
                        <tbody id="recurring-table-body" class="">
                            <?php if (empty($recurring_transactions)): ?>
                                <tr id="empty-state-recurring"><td colspan="5" class="text-center p-10">
                                    ...
                                    <h3 class="mt-2 text-sm font-medium ">Nessuna transazione ricorrente</h3>
    ...
    <div id="recurring-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-2xl p-6 transform scale-95 opacity-0 modal-content">
            <div class="flex justify-between items-center mb-6">
                <h2 id="recurring-modal-title" class="text-2xl font-bold ">Nuova Transazione Ricorrente</h2>
            ...
            <form id="recurring-form" action="" method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="description" id="recurring-description" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-1">Importo (€)</label>
                        <input type="number" step="0.01" name="amount" id="recurring-amount" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-1">Categoria</label>
                        <select name="category_id" id="recurring-category" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    ...
                    <div>
                        ...
                        <select name="account_id" id="recurring-account" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    ...
                    <div>
                        ...
                        <select name="frequency" id="recurring-frequency" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    ...
                    <div id="start-date-container">
                        ...
                        <input type="date" name="start_date" id="recurring-start-date" required value="<?php echo date('Y-m-d'); ?>" class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    </div>
                    <div id="next-date-container" class="hidden">
                        <label class="block text-sm font-medium text-gray-300 mb-1">Prossima Data</label>
                        <input type="date" name="next_due_date" id="recurring-next-date" class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    </div>
                </div>
                <div class="flex justify-end space-x-4 pt-4">
                    <button type="button" onclick="closeModal('recurring-modal')" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg">Annulla</button>
                    <button type="submit" id="recurring-submit-btn" class="bg-primary-600 hover:bg-primary-700  font-semibold py-2 px-5 rounded-lg">Salva</button>
                </div>
            </form>
        </div>
    </div>
