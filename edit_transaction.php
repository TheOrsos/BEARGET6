...
<body class="text-gray-200">
    <div class="flex h-screen">
        ...
        <aside class="w-64 flex-shrink-0 bg-gray-800 p-4 flex flex-col justify-between">
            <div>
                <div class="flex items-center mb-10">
                    ...
                    <span class="ml-3 text-2xl font-extrabold ">Bearget</span>
                </div>
                <nav class="space-y-2">
                    <?php if (isset($_SESSION['id']) && $_SESSION['id'] == 1): ?>
                        <a href="admin.php" class="flex items-center px-4 py-2.5 text-gray-400 hover:bg-gray-700 hover: rounded-lg transition-colors">
                    ...
                    <?php endif; ?>                   
                    <a href="dashboard.php" class="flex items-center px-4 py-2.5 text-gray-400 hover:bg-gray-700 hover: rounded-lg transition-colors">
                    ...
                    <a href="transactions.php" class="flex items-center px-4 py-2.5  bg-gray-900 rounded-lg font-semibold">
                    ...
                    <a href="accounts.php" class="flex items-center px-4 py-2.5 text-gray-400 hover:bg-gray-700 hover: rounded-lg transition-colors">
                    ...
                    <a href="categories.php" class="flex items-center px-4 py-2.5 text-gray-400 hover:bg-gray-700 hover: rounded-lg transition-colors">
                        <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                        Categorie
                    </a>
                    <a href="reports.php" class="flex items-center px-4 py-2.5 text-gray-400 hover:bg-gray-700 hover: rounded-lg transition-colors">
                        <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                        Report
                    </a>
                    <a href="budgets.php" class="flex items-center px-4 py-2.5 text-gray-400 hover:bg-gray-700 hover: rounded-lg transition-colors">
                        <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path></svg>
                        Budget
                    </a>
                    <a href="goals.php" class="flex items-center px-4 py-2.5 text-gray-400 hover:bg-gray-700 hover: rounded-lg transition-colors">
                    ...
                    <a href="recurring.php" class="flex items-center px-4 py-2.5 text-gray-400 hover:bg-gray-700 hover: rounded-lg transition-colors">
                    ...
                    <a href="shared_funds.php" class="flex items-center px-4 py-2.5 text-gray-400 hover:bg-gray-700 hover: rounded-lg transition-colors">
                        <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.653-.122-1.28-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.653.122-1.28.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                        Fondi Comuni
                    </a>
                    <a href="notifications.php" class="flex items-center px-4 py-2.5 text-gray-400 hover:bg-gray-700 hover: rounded-lg transition-colors relative">
                    ...
                    <a href="notes.php" class="flex items-center px-4 py-2.5 text-gray-400 hover:bg-gray-700 hover: rounded-lg transition-colors">
            ...
            <div class="border-t border-gray-700 pt-4">
                <a href="settings.php" class="flex items-center px-4 py-2.5 text-gray-400 hover:bg-gray-700 hover: rounded-lg transition-colors">
                ...
                <a href="bearget_info.html" target="_blank" class="flex items-center px-4 py-2.5 mt-2 text-gray-400 hover:bg-gray-700 hover: rounded-lg transition-colors">
                ...
                <a href="logout.php" class="flex items-center px-4 py-2.5 mt-2 text-red-400 hover:bg-red-500 hover: rounded-lg transition-colors">Logout</a>
            </div>
        </aside>
        ...
        <main class="flex-1 p-6 lg:p-10 overflow-y-auto">
            <header class="mb-8">
                <h1 class="text-3xl font-bold ">Modifica Transazione</h1>
                ...
                <form action="update_transaction.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" step="0.01" name="amount" id="amount" required value="<?php echo abs($transaction['amount']); ?>" class="w-full bg-gray-700 border-gray-600  rounded-lg px-3 py-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label for="transaction_date" class="block text-sm font-medium text-gray-300 mb-1">Data</label>
                            <input type="date" name="transaction_date" id="transaction_date" value="<?php echo $transaction['transaction_date']; ?>" required class="w-full bg-gray-700 border-gray-600  rounded-lg px-3 py-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div class="md:col-span-2">
                            <label for="description" class="block text-sm font-medium text-gray-300 mb-1">Descrizione</label>
                            <input type="text" name="description" id="description" required value="<?php echo htmlspecialchars($transaction['description']); ?>" class="w-full bg-gray-700 border-gray-600  rounded-lg px-3 py-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label for="account_id" class="block text-sm font-medium text-gray-300 mb-1">Conto</label>
                            <select name="account_id" id="account_id" required class="w-full bg-gray-700 border-gray-600  rounded-lg px-3 py-2 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div>
                            ...
                            <select name="category_id" id="category_id" required class="w-full bg-gray-700 border-gray-600  rounded-lg px-3 py-2 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div class="mt-6">
                            ...
                            <input type="text" name="tags" id="tags" value="<?php echo htmlspecialchars($tags_string); ?>" placeholder="Es. vacanze, lavoro, regali" class="w-full bg-gray-700  rounded-lg px-3 py-2">
                        </div>
                        <?php endif; ?>                        
                        ...
                        <div class="mt-6 border-t border-gray-700 pt-6">
                            ...
                            <?php endif; ?>
                            <input type="file" name="invoice_file" id="invoice_file" accept=".pdf,.jpg,.jpeg,.png" class="w-full text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-primary-600 file: hover:file:bg-primary-700">
                        </div>
                        <?php endif; ?>                        
                        </div>

                    <div class="mt-8 flex justify-end space-x-4">
                        <a href="transactions.php" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg transition-colors">Annulla</a>
                        <button type="submit" class="bg-primary-600 hover:bg-primary-700  font-semibold py-2 px-5 rounded-lg transition-colors">Salva Modifiche</button>
                    </div>
                </form>
            </div>
        </main>
