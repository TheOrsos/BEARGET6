...
<body class="text-gray-200 p-10">
    <h1 class="text-3xl font-bold ">Modifica Transazione Ricorrente</h1>
        ...
        <form action="update_recurring.php" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="description" value="<?php echo htmlspecialchars($recurring_transaction['description']); ?>" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                </div>
                <div>
                    <label>Importo (€)</label>
                    <input type="number" step="0.01" name="amount" value="<?php echo $recurring_transaction['amount']; ?>" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                </div>
                <div>
                    <label>Categoria</label>
                    <select name="category_id" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                ...
                <div>
                    ...
                    <select name="frequency" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                ...
                <div>
                    ...
                    <input type="date" name="next_due_date" required value="<?php echo $recurring_transaction['next_due_date']; ?>" class="w-full bg-gray-700  rounded-lg px-3 py-2">
                </div>
            </div>
            <div class="flex justify-end space-x-4 pt-4">
                <a href="recurring.php" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg">Annulla</a>
                <button type="submit" class="bg-primary-600 hover:bg-primary-700  font-semibold py-2 px-5 rounded-lg">Salva Modifiche</button>
            </div>
        </form>
    </div>
</body>
