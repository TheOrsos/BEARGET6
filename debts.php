                            ...
                            <?php else: ?>
                                ...
                                <tr class="border-b border-gray-700 last:border-b-0">
                                    ...
                                    <td class="p-4 text-center">
                                        ...
                                        <?php else: ?>
                                            <a href="friends.php?search_query=<?php echo urlencode($debt['friend_name']); ?>" class="inline-flex items-center justify-center px-3 py-1.5 text-sm font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700" title="Visualizza Amico">
                                                Vai a Amici
