    ...
    <div class="w-full max-w-md p-8 space-y-8 bg-white rounded-2xl shadow-lg">
        ...
        <?php if (isset($_GET['reset_link'])): ?>
             <div class="text-center">
                ...
                <a href="<?php echo htmlspecialchars(urldecode($_GET['reset_link'])); ?>" class="inline-block w-full justify-center rounded-md border border-transparent bg-green-600 py-3 px-4 text-sm font-semibold  hover:bg-green-700">
        ...
        <?php else: ?>
            <form class="mt-8 space-y-6" action="send_reset_link.php" method="POST">
                ...
                <div>
                    <button type="submit" class="group relative flex w-full justify-center rounded-md border border-transparent bg-indigo-600 py-3 px-4 text-sm font-semibold  hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
