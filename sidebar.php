...
<aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-gray-800 p-4 flex flex-col transform -translate-x-full lg:relative lg:translate-x-0 transition-transform duration-300 ease-in-out z-40">
    ...
    <nav class="flex-grow overflow-y-auto space-y-2 no-scrollbar">
        <?php if (isset($_SESSION['id']) && $_SESSION['id'] == 1): ?>
            <a href="admin.php" class="flex items-center px-4 py-2.5 rounded-lg transition-colors <?php echo ($current_page == 'admin') ? ' bg-gray-900 font-semibold' : 'text-gray-400 hover:bg-gray-700 hover:'; ?>">
        ...
        <?php endif; ?>
        <a href="dashboard.php" class="flex items-center px-4 py-2.5 rounded-lg transition-colors <?php echo ($current_page == 'dashboard') ? ' bg-gray-900 font-semibold' : 'text-gray-400 hover:bg-gray-700 hover:'; ?>">
        ...
        <a href="transactions.php" class="flex items-center px-4 py-2.5 rounded-lg transition-colors <?php echo ($current_page == 'transactions') ? ' bg-gray-900 font-semibold' : 'text-gray-400 hover:bg-gray-700 hover:'; ?>">
        ...
        <a href="accounts.php" class="flex items-center px-4 py-2.5 rounded-lg transition-colors <?php echo ($current_page == 'accounts') ? ' bg-gray-900 font-semibold' : 'text-gray-400 hover:bg-gray-700 hover:'; ?>">
        ...
        <a href="purchase_planner.php" class="flex items-center justify-between px-4 py-2.5 rounded-lg transition-colors <?php echo ($current_page == 'purchase_planner') ? ' bg-gray-900 font-semibold' : 'text-gray-400 hover:bg-gray-700 hover:'; ?>">
            <div class="flex items-center">
        ...
        <a href="reports.php" class="flex items-center justify-between px-4 py-2.5 rounded-lg transition-colors <?php echo ($current_page == 'reports') ? ' bg-gray-900 font-semibold' : 'text-gray-400 hover:bg-gray-700 hover:'; ?>">
            <div class="flex items-center">
        ...
        <a href="budgets.php" class="flex items-center justify-between px-4 py-2.5 rounded-lg transition-colors <?php echo ($current_page == 'budgets') ? ' bg-gray-900 font-semibold' : 'text-gray-400 hover:bg-gray-700 hover:'; ?>">
            <div class="flex items-center">
        ...
        <a href="goals.php" class="flex items-center justify-between px-4 py-2.5 rounded-lg transition-colors <?php echo ($current_page == 'goals') ? ' bg-gray-900 font-semibold' : 'text-gray-400 hover:bg-gray-700 hover:'; ?>">
            <div class="flex items-center">
        ...
        <a href="recurring.php" class="flex items-center justify-between px-4 py-2.5 rounded-lg transition-colors <?php echo ($current_page == 'recurring') ? ' bg-gray-900 font-semibold' : 'text-gray-400 hover:bg-gray-700 hover:'; ?>">
            <div class="flex items-center">
        ...
        <a href="shared_funds.php" class="flex items-center justify-between px-4 py-2.5 rounded-lg transition-colors <?php echo ($current_page == 'shared_funds') ? ' bg-gray-900 font-semibold' : 'text-gray-400 hover:bg-gray-700 hover:'; ?>">
            <div class="flex items-center">
        ...
        <a href="friends.php" class="flex items-center px-4 py-2.5 rounded-lg transition-colors relative <?php echo ($current_page == 'friends') ? ' bg-gray-900 font-semibold' : 'text-gray-400 hover:bg-gray-700 hover:'; ?>">
        ...
        <a href="tags.php" class="flex items-center px-4 py-2.5 rounded-lg transition-colors <?php echo ($current_page == 'tags') ? ' bg-gray-900 font-semibold' : 'text-gray-400 hover:bg-gray-700 hover:'; ?>">
        ...
        <a href="notes.php" class="flex items-center px-4 py-2.5 rounded-lg transition-colors <?php echo ($current_page == 'notes') ? ' bg-gray-900 font-semibold' : 'text-gray-400 hover:bg-gray-700 hover:'; ?>">
        ...
        <a href="notifications.php" class="flex items-center px-4 py-2.5 rounded-lg transition-colors relative <?php echo ($current_page == 'notifications') ? ' bg-gray-900 font-semibold' : 'text-gray-400 hover:bg-gray-700 hover:'; ?>">
        ...
        <a href="changelog.php" class="flex items-center px-4 py-2.5 rounded-lg transition-colors <?php echo ($current_page == 'changelog') ? ' bg-gray-900 font-semibold' : 'text-gray-400 hover:bg-gray-700 hover:'; ?>">
    ...
    <div class="border-t border-gray-700 pt-4 flex-shrink-0">
        <a href="settings.php" class="flex items-center px-4 py-2.5 rounded-lg transition-colors text-gray-400 hover:bg-gray-700 hover:">
            <?php
            ...
            <?php else: ?>
                <div class="w-10 h-10 rounded-full bg-gray-700 mr-3 flex items-center justify-center">
                    <span class=" font-bold"><?php echo strtoupper(substr($user_sidebar_data['username'], 0, 1)); ?></span>
                </div>
            <?php endif; ?>
            <div>
                <span class="font-semibold "><?php echo htmlspecialchars($user_sidebar_data['username']); ?></span>
                <p class="text-xs text-gray-500">Visualizza profilo</p>
            </div>
        </a>
        <a href="bearget_info.php" target="_blank" class="flex items-center px-4 py-2.5 mt-2 text-gray-400 hover:bg-gray-700 hover: rounded-lg transition-colors">
