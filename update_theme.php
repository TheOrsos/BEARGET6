...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $valid_themes = ['dark-indigo', 'forest-green', 'ocean-blue', 'sunset-orange', 'royal-purple', 'graphite-gray', 'dark-gold', 'modern-dark', 'foggy-gray', 'crimson-white', 'neon-dreams', 'lunar-rays', 'violet-night', 'autumn-breeze', 'jungle-heart', 'ice-kingdom', 'willow-tree'];
