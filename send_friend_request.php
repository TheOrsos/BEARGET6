...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['friend_code'])) {
    ...
    if (check_block_status($conn, $requester_id, $receiver_id)) {
        header("location: friends.php?message=Azione non permessa. Uno degli utenti ha bloccato l'altro.&type=error");
        exit;
    }
    // --- FINE CONTROLLO ---
