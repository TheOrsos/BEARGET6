...
<body class="text-gray-300">
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="bg-gray-800 rounded-2xl p-8 max-w-md w-full text-center">
            <h1 class="text-3xl font-bold ">Passa a Bearget Pro (Beta)</h1>
            ...
            <div class="my-8">
                <span class="text-5xl font-extrabold ">€4,99</span>
        ...
        <!-- Bottone Stripe -->
        <a href="<?php echo htmlspecialchars($final_link); ?>" id="proButton" class="block w-full bg-primary-600 hover:bg-primary-700  font-semibold py-3 rounded-lg text-lg transition-colors opacity-50">
            Abbonati Ora
        </a>
