...
<body class="text-gray-200">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold  flex items-center gap-3">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.25278C12 6.25278 10.8333 5 9.5 5C8.16667 5 7 6.25278 7 6.25278V9.74722C7 9.74722 8.16667 11 9.5 11C10.8333 11 12 9.74722 12 9.74722V6.25278ZM12 6.25278C12 6.25278 13.1667 5 14.5 5C15.8333 5 17 6.25278 17 6.25278V9.74722C17 9.74722 15.8333 11 14.5 11C13.1667 11 12 9.74722 12 9.74722V6.25278Z"></path></svg>
                            Obiettivi di Risparmio
                        </h1>
                        <p class="text-gray-400 mt-1">Traccia i progressi verso i tuoi sogni.</p>
                    </div>
                </div>
                <button onclick="openModal('add-goal-modal')" class="bg-primary-600 hover:bg-primary-700  font-semibold py-2 px-5 rounded-lg flex items-center transition-colors shadow-lg hover:shadow-primary-500/50">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                    Crea Obiettivo
                </button>
            </header>

            <div id="goals-grid" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 overflow-y-auto" style="max-height: calc(100vh - 10rem);">
                <?php if (empty($goals)): ?>
                    <div id="empty-state-goals" class="md:col-span-2 xl:col-span-3 bg-gray-800 rounded-2xl p-10 text-center flex flex-col items-center">
                        ...
                        <h3 class="text-lg font-semibold ">Nessun obiettivo impostato</h3>
                        ...
                        <button onclick="openModal('add-goal-modal')" class="mt-6 bg-primary-600 hover:bg-primary-700  font-semibold py-2 px-5 rounded-lg flex items-center transition-colors shadow-lg hover:shadow-primary-500/50">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
                    ...
                    <div class="bg-gray-800 rounded-2xl p-5 flex flex-col transition-transform duration-200 hover:-translate-y-1 hover:shadow-2xl" data-goal-id="<?php echo $goal['id']; ?>">
                        <div class="flex-grow">
                            <div class="flex justify-between items-start">
                                <h3 class="text-xl font-bold  mb-2 goal-name"><?php echo htmlspecialchars($goal['name']); ?></h3>
                        ...
                        <div class="mt-4">
                            <button onclick="openContributionModal(<?php echo $goal['id']; ?>, '<?php echo htmlspecialchars(addslashes($goal['name'])); ?>')" class="w-full bg-gray-700 hover:bg-gray-600  font-semibold py-2 rounded-lg">Aggiungi Fondi</button>
                        </div>
                    </div>
                    <?php endforeach; ?>
                <?php endif; ?>
    ...
    <div id="add-goal-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl w-full max-w-md p-6 transform scale-95 opacity-0 modal-content">
            <h2 class="text-2xl font-bold  mb-6">Crea Nuovo Obiettivo</h2>
            <form id="add-goal-form" action="add_goal.php" method="POST" class="space-y-4">
                <div>
                    ...
                    <input type="text" name="name" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                </div>
                <div>
                    <label for="target_amount" class="block text-sm font-medium text-gray-300 mb-1">Importo Obiettivo (€)</label>
                    <input type="number" step="0.01" name="target_amount" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                </div>
                <div>
                    <label for="target_date" class="block text-sm font-medium text-gray-300 mb-1">Data di Scadenza (Opzionale)</label>
                    <input type="date" name="target_date" class="w-full bg-gray-700  rounded-lg px-3 py-2">
                </div>
                <div class="pt-4 flex justify-end space-x-4">
                    <button type="button" onclick="closeModal('add-goal-modal')" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg">Annulla</button>
                    <button type="submit" class="bg-primary-600 hover:bg-primary-700  font-semibold py-2 px-5 rounded-lg">Crea</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="edit-goal-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl w-full max-w-md p-6 transform scale-95 opacity-0 modal-content">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-bold ">Modifica Obiettivo</h2>
            ...
            <form id="edit-goal-form" action="update_goal.php" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="edit-name" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                </div>
                <div>
                    <label for="edit-target-amount" class="block text-sm font-medium text-gray-300 mb-1">Importo Obiettivo (€)</label>
                    <input type="number" step="0.01" name="target_amount" id="edit-target-amount" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                </div>
                <div>
                    <label for="edit-target-date" class="block text-sm font-medium text-gray-300 mb-1">Data di Scadenza (Opzionale)</label>
                    <input type="date" name="target_date" id="edit-target-date" class="w-full bg-gray-700  rounded-lg px-3 py-2">
                </div>
                <div class="pt-4 flex justify-end space-x-4">
                    <button type="button" onclick="closeModal('edit-goal-modal')" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg">Annulla</button>
    ...
    <div id="add-contribution-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl w-full max-w-md p-6 transform scale-95 opacity-0 modal-content">
            <h2 class="text-2xl font-bold  mb-2">Aggiungi Fondi</h2>
            ...
            <form id="add-contribution-form" action="add_contribution.php" method="POST" class="space-y-4">
                ...
                <div class="pt-4 flex justify-end space-x-4">
                    ...
                    <button type="submit" class="bg-green-600 hover:bg-green-700  font-semibold py-2 px-5 rounded-lg">Aggiungi</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="confirm-delete-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-md p-6 transform scale-95 opacity-0 modal-content text-center">
            ...
            <h3 class="text-lg leading-6 font-bold  mt-4">Eliminare Obiettivo?</h3>
    ...
    <div id="history-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl w-full max-w-2xl p-6 transform scale-95 opacity-0 modal-content">
            <h2 class="text-2xl font-bold  mb-2">Cronologia per <span id="history-goal-name" class="text-primary-500"></span></h2>
            ...
            <div id="history-list-container" class="max-h-96 overflow-y-auto space-y-3 pr-2">
             ...
             <div class="mt-8 flex justify-end">
                <button type="button" onclick="closeModal('history-modal')" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg">Chiudi</button>
            </div>
        </div>
    </div>
        ...
        <div class="bg-gray-800 rounded-2xl w-full max-w-md p-6 transform scale-95 opacity-0 modal-content">
            ...
            <form id="edit-contribution-form" action="edit_contribution.php" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="date" name="date" id="edit-contribution-date" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                </div>
                <div class="pt-4 flex justify-end space-x-4">
    ...
    <div id="confirm-delete-contribution-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-md p-6 transform scale-95 opacity-0 modal-content text-center">
            ...
            <div class="mt-8 flex justify-center space-x-4">
                <button id="confirm-delete-contribution-btn" type="button" class="bg-danger hover:bg-red-700  font-semibold py-2 px-5 rounded-lg">Elimina</button>
    ...
    <div id="note-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-lg p-6 transform scale-95 opacity-0 modal-content">
            <h2 class="text-2xl font-bold  mb-4">Nota del Contributo</h2>
            <form id="note-form">
