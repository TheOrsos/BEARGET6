    ...
    <div class="w-full max-w-md p-8 space-y-8 bg-white rounded-2xl shadow-lg">
        ...
        <?php if ($token_valid): ?>
            <form class="mt-8 space-y-6" action="update_password_from_reset.php" method="POST">
                ...
                <div>
                    <button type="submit" class="group relative flex w-full justify-center rounded-md border border-transparent bg-indigo-600 py-3 px-4 text-sm font-semibold  hover:bg-indigo-700">
