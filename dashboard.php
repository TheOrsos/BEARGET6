            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-gray-800 p-6 rounded-2xl"><h3 class="text-gray-400 text-sm font-medium">Saldo Totale</h3><p id="total-balance" class="text-3xl font-extrabold  mt-1">€<?php echo number_format($totalBalance, 2, ',', '.'); ?></p></div>
                    ...
                    <div class="bg-gray-800 p-6 rounded-2xl">
                        <h3 class="text-xl font-bold  mb-4">Transazioni Recenti</h3>
                        <div id="recent-transactions-list" class="space-y-4">
                            <?php if (empty($recentTransactions)): ?>
                                <div id="empty-state-transactions" class="text-center py-8">
                                    ...
                                    <h3 class="mt-2 text-sm font-medium ">Nessuna transazione</h3>
                ...
                <div class="lg:col-span-1 bg-gray-800 p-6 rounded-2xl flex flex-col">
                    <h3 class="text-xl font-bold  mb-4">Spese per Categoria</h3>
            ...
            <form id="form-expense-income" action="add_transaction.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="account_id" id="account_id" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    ...
                    <div>
                        ...
                        <select name="category_id" id="category_id" required class="w-full bg-gray-700  rounded-lg px-3 py-2"></select>
                    </div>
                    <?php if ($is_pro_user): ?>
                    <div class="md:col-span-2">
                        <label for="tags" class="block text-sm font-medium text-gray-300 mb-1">Etichette (separate da virgola)</label>
                        <input type="text" name="tags" placeholder="Es. vacanze, lavoro, regali" class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    </div>
                    <div class="md:col-span-2">
    ...
    <script>
        ...
        function switchTab(activeTab) {
            [tabExpense, tabIncome, tabTransfer].forEach(tab => {
                tab.classList.remove('', 'border-primary-500');
                tab.classList.add('text-gray-400', 'border-transparent');
            });
            activeTab.classList.add('', 'border-primary-500');
