...
-- Creato il: Ago 14, 2025 alle 12:19
...
(1, 1, 'Stipendio', '800.00', 'income', 1, 1, 'monthly', '2025-08-14', '2025-08-14', '2025-08-14 05:12:50');
...
INSERT INTO `settlement_payments` (`id`, `fund_id`, `from_user_id`, `to_user_id`, `amount`, `status`, `created_at`, `payer_confirmed_at`, `payee_confirmed_at`) VALUES
(1, 2, 2, 1, '10.00', 'pending', '2025-08-14 05:25:01', NULL, NULL);
...
(7, 1, 1, 10, '-20.00', 'expense', 'Spesa di gruppo \'Tokyo\': 100', '2025-08-14', '2025-08-14 05:24:45', NULL, NULL, NULL);
