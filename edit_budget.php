...
<body class="text-gray-200">
    <div class="flex h-screen">
        ...
        <aside class="w-64 flex-shrink-0 bg-gray-800 p-4 flex flex-col justify-between">
            <div>
                ...
                <nav class="space-y-2">
                    ...
                    <a href="budgets.php" class="flex items-center px-4 py-2.5  bg-gray-900 rounded-lg font-semibold">
        ...
        <main class="flex-1 p-6 lg:p-10 overflow-y-auto">
            <header class="mb-8">
                <h1 class="text-3xl font-bold ">Modifica Budget</h1>
                ...
                <form action="update_budget.php" method="POST">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="number" step="0.01" name="amount" id="amount" required value="<?php echo $budget['amount']; ?>" class="w-full bg-gray-700 border-gray-600  rounded-lg px-3 py-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                    <div class="mt-8 flex justify-end space-x-4">
                        <a href="budgets.php" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg transition-colors">Annulla</a>
