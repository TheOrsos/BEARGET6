...
<body class="text-gray-300">
            ...
            <header class="flex flex-wrap justify-between items-center gap-4 mb-8">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 mt-1">Gestisci le etichette per organizzare le transazioni.</p>
                    </div>
                </div>
                 <button onclick="openModal('add-tag-modal')" class="bg-primary-600 hover:bg-primary-700  font-semibold py-2 px-5 rounded-lg flex items-center transition-colors shadow-lg hover:shadow-primary-500/50">
                ...
                <div id="tags-list-container" class="space-y-3">
                    <?php if (empty($user_tags)): ?>
                        <div id="empty-state-tags" class="text-center py-10">
                            ...
                            <h3 class="mt-2 text-sm font-medium ">Nessuna etichetta creata</h3>
    ...
    <div id="add-tag-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl w-full max-w-md p-6 transform scale-95 opacity-0 modal-content">
            <h2 class="text-2xl font-bold  mb-6">Crea Nuova Etichetta</h2>
            <form id="add-tag-form" action="add_tag.php" method="POST" class="space-y-4">
                <div>
                    ...
                    <input type="text" name="name" id="tag_name" required placeholder="Es. ViaggioSpagna2025" class="w-full bg-gray-700 border-gray-600  rounded-lg px-3 py-2">
                    <p class="text-xs text-gray-500 mt-1">Senza #, spazi o caratteri speciali.</p>
                </div>
                <div class="pt-4 flex justify-end space-x-4">
                    <button type="button" onclick="closeModal('add-tag-modal')" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg">Annulla</button>
                    <button type="submit" class="bg-primary-600 hover:bg-primary-700  font-semibold py-2.5 px-5 rounded-lg transition-colors">Salva Etichetta</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="edit-tag-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl w-full max-w-md p-6 transform scale-95 opacity-0 modal-content">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-bold ">Modifica Etichetta</h2>
            ...
            <form id="edit-tag-form" action="update_tag.php" method="POST">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="name" id="edit-tag-name" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                        <p class="text-xs text-gray-500 mt-1">Senza #, spazi o caratteri speciali.</p>
                    </div>
                </div>
                <div class="mt-8 flex justify-end space-x-4">
                    <button type="button" onclick="closeModal('edit-tag-modal')" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg">Annulla</button>
                    <button type="submit" class="bg-green-600 hover:bg-green-700  font-semibold py-2 px-5 rounded-lg">Salva</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="confirm-delete-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-md p-6 transform scale-95 opacity-0 modal-content text-center">
            ...
            <h3 class="text-lg leading-6 font-bold  mt-4">Eliminare Etichetta?</h3>
