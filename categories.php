...
<body class="text-gray-300">
            ...
            <header class="mb-8">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 mt-1">Personalizza le categorie</p>
                    </div>
                </div>
            </header>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-gray-800 rounded-2xl p-6 flex flex-col" style="height: calc(100vh - 10rem);">
                    ...
                    <form action="add_category.php" method="POST" class="add-form space-y-3">
                        ...
                        <h3 class="font-semibold ">Aggiungi Nuova Categoria di Spesa</h3>
                        <div class="flex gap-3" style="flex-wrap: wrap;">
                            <input type="text" name="name" placeholder="Nome Categoria" required class="flex-grow bg-gray-900 border-gray-700  rounded-lg px-3 py-2 focus:ring-primary-500 focus:border-primary-500">
                            <input type="text" name="icon" placeholder="Icona" maxlength="2" class="w-24 bg-gray-900 border-gray-700  rounded-lg px-3 py-2 text-center focus:ring-primary-500 focus:border-primary-500">
                            <button type="submit" class="bg-primary-600 hover:bg-primary-700  font-semibold py-2 px-4 rounded-lg transition-colors">Aggiungi</button>
                        </div>
                    </form>
                </div>
                ...
                <div class="bg-gray-800 rounded-2xl p-6 flex flex-col" style="height: calc(100vh - 10rem);">
                    ...
                    <form action="add_category.php" method="POST" class="add-form space-y-3">
                        ...
                        <h3 class="font-semibold ">Aggiungi Nuova Categoria di Entrata</h3>
                        <div class="flex gap-3" style="flex-wrap: wrap;">
                            <input type="text" name="name" placeholder="Nome Categoria" required class="flex-grow bg-gray-900 border-gray-700  rounded-lg px-3 py-2 focus:ring-primary-500 focus:border-primary-500">
                            <input type="text" name="icon" placeholder="Icona" maxlength="2" class="w-24 bg-gray-900 border-gray-700  rounded-lg px-3 py-2 text-center focus:ring-primary-500 focus:border-primary-500">
                            <button type="submit" class="bg-primary-600 hover:bg-primary-700  font-semibold py-2 px-4 rounded-lg transition-colors">Aggiungi</button>
    ...
    <div id="edit-category-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-md p-6 transform scale-95 opacity-0 modal-content">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-bold ">Modifica Categoria</h2>
            ...
            <form id="edit-category-form" action="update_category.php" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="edit-category-name" required class="w-full bg-gray-700 border-gray-600  rounded-lg px-3 py-2">
                </div>
                <div>
                    <label for="edit-category-icon" class="block text-sm font-medium text-gray-300 mb-1">Icona (Emoji)</label>
                    <input type="text" name="icon" id="edit-category-icon" maxlength="2" class="w-full bg-gray-700 border-gray-600  rounded-lg px-3 py-2">
                </div>
                <div class="pt-4 flex justify-end space-x-4">
                    <button type="button" onclick="closeModal('edit-category-modal')" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg">Annulla</button>
    ...
    <div id="confirm-delete-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-md p-6 transform scale-95 opacity-0 modal-content text-center">
            ...
            <h3 class="text-lg leading-6 font-bold  mt-4">Eliminare Categoria?</h3>
