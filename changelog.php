            ...
            <header class="mb-8">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 mt-1">Scopri le ultime funzionalità e di Bearget.</p>
                    </div>
                </div>
            </header>
                    ...
                    <article class="bg-gray-800/50 rounded-2xl overflow-hidden">
                        ...
                        <div class="p-8">
                            <div class="flex items-center gap-4 mb-2">
                                <span class="px-3 py-1 bg-primary-600  text-sm font-bold rounded-full"><?php echo htmlspecialchars($update['version']); ?></span>
                            ...
                            <h2 class="text-3xl font-bold  mt-2"><?php echo htmlspecialchars($update['title']); ?></h2>
