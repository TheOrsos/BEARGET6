...
<body class="text-gray-200">
        ...
        <main class="flex-1 p-6 lg:p-10 overflow-y-auto">
            <header class="flex flex-wrap justify-between items-center gap-4 mb-8">
                ...
                <div class="flex items-center space-x-2">
                    <button id="toggle-filter-btn" class="bg-gray-600 hover:bg-gray-500  font-semibold py-2 px-4 rounded-lg flex items-center transition-colors">
                    ...
                    <button onclick="openModal('import-modal')" class="bg-gray-700 hover:bg-gray-600  font-semibold py-2 px-4 rounded-lg flex items-center transition-colors">Importa</button>
                    <a href="export_transactions.php?<?php echo $export_query_string; ?>" id="export-link" class="bg-gray-700 hover:bg-gray-600  font-semibold py-2 px-4 rounded-lg flex items-center transition-colors">Esporta</a>
                    <button onclick="openModal('add-transaction-modal')" class="bg-primary-600 hover:bg-primary-700 font-semibold py-2 px-5 rounded-lg flex items-center transition-colors">
            ...
            <!-- MODULO FILTRI -->
             <div id="filter-container" class="bg-gray-800 rounded-2xl p-4 mb-6 hidden">
                <form id="transactions-filter-form" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-4 items-end">
                    <div>
                        <label for="start_date" class="text-sm font-medium text-gray-400">Da</label>
                        <input type="date" name="start_date" id="start_date" value="<?php echo htmlspecialchars($filters['start_date']); ?>" class="w-full bg-gray-700 rounded-lg px-3 py-2 mt-1 text-sm">
                    </div>
                    <div>
                        <label for="end_date" class="text-sm font-medium text-gray-400">A</label>
                        <input type="date" name="end_date" id="end_date" value="<?php echo htmlspecialchars($filters['end_date']); ?>" class="w-full bg-gray-700 rounded-lg px-3 py-2 mt-1 text-sm">
                    </div>
                    <div>
                        <label for="description" class="text-sm font-medium text-gray-400">Descrizione</label>
                        <input type="text" name="description" id="description" value="<?php echo htmlspecialchars($filters['description']); ?>" placeholder="Cerca..." class="w-full bg-gray-700 rounded-lg px-3 py-2 mt-1 text-sm">
                    </div>
                    <div>
                        <label for="account_id" class="text-sm font-medium text-gray-400">Conto</label>
                        <select name="account_id" id="account_id" class="w-full bg-gray-700 rounded-lg px-3 py-2 mt-1 text-sm">
                    ...
                    <div>
                        ...
                        <select name="category_id" id="category_id" class="w-full bg-gray-700 rounded-lg px-3 py-2 mt-1 text-sm">
                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody id="transactions-table-body">
                            <?php if (empty($allTransactions)): ?>
                                <tr id="empty-state-transactions"><td colspan="6" class="text-center p-10">Nessuna transazione trovata.</td></tr>
                            <?php else: ?>
                                <?php // Initial rows are rendered by PHP ?>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
    ...
    <div id="add-transaction-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-lg p-6 transform scale-95 opacity-0 modal-content" style="height: -webkit-fill-available; overflow: auto;">
            <h2 class="text-2xl font-bold mb-2">Aggiungi Movimento</h2>
            <p class="text-gray-400 mb-6">Inserisci i dettagli del movimento.</p>
            <div class="mb-4">
                <div class="flex border-b border-gray-700">
                    <button type="button" id="tab-expense" class="tab-btn flex-1 py-2 font-semibold  border-b-2 border-primary-500">Uscita</button>
            ...
            <form id="form-expense-income" action="add_transaction.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" step="0.01" name="amount" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-1">Data</label>
                        <input type="date" name="transaction_date" value="<?php echo date('Y-m-d'); ?>" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-300 mb-1">Descrizione</label>
                        <input type="text" name="description" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-1">Conto</label>
                        <select name="account_id" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            ...
                            <input type="text" id="add-category-name-display" placeholder="Seleziona una categoria" readonly required class="flex-grow bg-gray-700  rounded-lg px-3 py-2 cursor-pointer">
                            <button type="button" id="choose-category-btn-add" class="bg-gray-600 hover:bg-gray-500  font-semibold py-2 px-4 rounded-lg">Scegli</button>
                        </div>
                    </div>
                    <?php if ($is_pro_user): ?>
                    <div class="md:col-span-2">
                        ...
                        <div class="flex gap-2">
                            <input type="text" name="tags" id="tags-input-add" placeholder="Es. vacanze, lavoro, regali" class="flex-grow bg-gray-700  rounded-lg px-3 py-2">
                            <button type="button" id="choose-tags-btn-add" class="bg-gray-600 hover:bg-gray-500  font-semibold py-2 px-4 rounded-lg">Scegli</button>
                        </div>
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-300 mb-1">Allega Fattura (Max 2MB)</label>
                        <input type="file" name="invoice_file" accept=".pdf,.jpg,.jpeg,.png" class="w-full text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-primary-600 file: hover:file:bg-primary-700">
                    </div>
                    <?php endif; ?>
                </div>
                <div class="mt-8 flex justify-end space-x-4">
                    <button type="button" onclick="closeModal('add-transaction-modal')" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg">Annulla</button>
                    <button type="submit" class="bg-primary-600 hover:bg-primary-700  font-semibold py-2 px-5 rounded-lg">Salva</button>
                </div>
            </form>
            <form id="form-transfer" action="add_transfer.php" method="POST" class="hidden">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-300 mb-1">Descrizione</label>
                        <input type="text" name="description" placeholder="Es. Spostamento su conto risparmi" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-1">Da Conto</label>
                        <select name="from_account_id" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                            <?php foreach($userAccounts as $account): ?><option value="<?php echo $account['id']; ?>"><?php echo htmlspecialchars($account['name']); ?></option><?php endforeach; ?>
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-1">A Conto</label>
                        <select name="to_account_id" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                            <?php foreach($userAccounts as $account): ?><option value="<?php echo $account['id']; ?>"><?php echo htmlspecialchars($account['name']); ?></option><?php endforeach; ?>
                        </select>
                    </div>
                </div>
                <div class="mt-8 flex justify-end space-x-4">
                    <button type="button" onclick="closeModal('add-transaction-modal')" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg">Annulla</button>
                    <button type="submit" class="bg-primary-600 hover:bg-primary-700  font-semibold py-2 px-5 rounded-lg">Salva Trasferimento</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="edit-transaction-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-lg p-6 transform scale-95 opacity-0 modal-content">
            <h2 class="text-2xl font-bold  mb-6">Modifica Movimento</h2>
            <form id="edit-transaction-form" action="update_transaction.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-1">Importo</label>
                        <input type="number" step="0.01" name="amount" id="edit-amount" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-1">Data</label>
                        <input type="date" name="transaction_date" id="edit-date" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-300 mb-1">Descrizione</label>
                        <input type="text" name="description" id="edit-description" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-300 mb-1">Conto</label>
                        <select name="account_id" id="edit-account" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                            <?php foreach($userAccounts as $account): ?><option value="<?php echo $account['id']; ?>"><?php echo htmlspecialchars($account['name']); ?></option><?php endforeach; ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <div class="flex gap-2">
                            ...
                            <input type="text" id="edit-category-name-display" placeholder="Seleziona una categoria" readonly required class="flex-grow bg-gray-700  rounded-lg px-3 py-2 cursor-pointer">
                            <button type="button" id="choose-category-btn-edit" class="bg-gray-600 hover:bg-gray-500  font-semibold py-2 px-4 rounded-lg">Scegli</button>
                        </div>
                    </div>
                    <?php if ($is_pro_user): ?>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-300 mb-1">Etichette</label>
                        <div class="flex gap-2">
                            <input type="text" name="tags" id="edit-tags" class="flex-grow bg-gray-700  rounded-lg px-3 py-2">
                            <button type="button" id="choose-tags-btn-edit" class="bg-gray-600 hover:bg-gray-500  font-semibold py-2 px-4 rounded-lg">Scegli</button>
                        </div>
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <div id="invoice-management-area" class="space-y-2">
                            ...
                            <input type="file" name="invoice_file" id="edit-invoice-file" accept=".pdf,.jpg,.jpeg,.png" class="w-full text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-primary-600 file: hover:file:bg-primary-700">
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
                <div class="mt-8 flex justify-end space-x-4">
                    <button type="button" onclick="closeModal('edit-transaction-modal')" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg">Annulla</button>
    ...
    <div id="confirm-delete-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-md p-6 transform scale-95 opacity-0 modal-content text-center">
            ...
            <h3 class="text-lg leading-6 font-bold  mt-4">Eliminare Transazione?</h3>
            ...
            <div class="mt-8 flex justify-center space-x-4">
                <button id="confirm-delete-btn" type="button" class="bg-danger hover:bg-red-700  font-semibold py-2 px-5 rounded-lg">Elimina</button>
    ...
    <div id="note-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-lg p-6 transform scale-95 opacity-0 modal-content">
            <h2 class="text-2xl font-bold  mb-4">Nota della Transazione</h2>
            <form id="note-form">
                <input type="hidden" id="note-transaction-id" name="transaction_id">
                <textarea id="note-content" name="note_content" rows="6" class="w-full bg-gray-700  rounded-lg px-3 py-2" placeholder="Scrivi qui la tua nota..."></textarea>
                <div class="mt-6 flex justify-end space-x-4">
                    <button type="button" onclick="closeModal('note-modal')" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg">Annulla</button>
                    <button type="submit" class="bg-yellow-600 hover:bg-yellow-700  font-semibold py-2 px-5 rounded-lg">Salva Nota</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function switchTab(activeTab) {
                const tabs = [tabExpense, tabIncome, tabTransfer];
                tabs.forEach(tab => {
                    if (tab) { // Aggiunto controllo per sicurezza
  ...
  // --- LIVE SEARCH SCRIPT ---
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function renderTransactions(transactions) {
            ...
            if (transactions.length === 0) {
                tableBody.innerHTML = '<tr id="empty-state-transactions"><td colspan="6" class="text-center p-10">Nessuna transazione trovata con questi criteri.</td></tr>';
                return;
            }
            ...
            transactions.forEach(tx => {
                ...
                const formattedAmount = new Intl.NumberFormat('it-IT', { style: 'currency', currency: 'EUR' }).format(tx.amount);
                const formattedDate = new Date(tx.transaction_date + 'T00:00:00').toLocaleDateString('it-IT');
                const tagsHTML = tx.tags ? `<div class="text-xs text-indigo-400 mt-1 font-normal tags-cell">${escapeHTML(tx.tags)}</div>` : '';
                const invoiceLinkHTML = tx.invoice_path ? `<a href="${escapeHTML(tx.invoice_path)}" target="_blank" title="Visualizza allegato" class="p-2 hover:bg-gray-700 rounded-full transition-colors invoice-link"><svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13"></path></svg></a>` : '';

                const row = `
                    <tr class="border-b border-gray-700 last:border-b-0 transition-colors hover:bg-gray-700/50" data-transaction-id="${tx.id}">
                        <td class="p-4 whitespace-nowrap date-cell">${formattedDate}</td>
                        <td class="p-4 font-semibold description-cell">${escapeHTML(tx.description)}${tagsHTML}</td>
                        <td class="p-4 category-cell">${escapeHTML(tx.category_name || 'N/A')}</td>
                        <td class="p-4 text-gray-400 account-cell">${escapeHTML(tx.account_name)}</td>
                        <td class="p-4 text-right font-bold amount-cell ${amountClass}">${formattedAmount}</td>
                        <td class="p-4">
                            <div class="flex justify-center items-center space-x-2 action-buttons">
                                <button onclick="openNoteModal(${tx.id})" title="Aggiungi/Modifica Nota" class="p-2 hover:bg-gray-700 rounded-full transition-colors"><svg class="w-5 h-5 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg></button>
                                ${invoiceLinkHTML}
                                <button onclick='openEditTransactionModal(${JSON.stringify(tx)})' title="Modifica" class="p-2 hover:bg-gray-700 rounded-full transition-colors"><svg class="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.536L16.732 3.732z"></path></svg></button>
                                <form action="delete_transaction.php" method="POST" class="delete-form">
                                    <input type="hidden" name="transaction_id" value="${tx.id}">
                                    <button type="submit" title="Elimina" class="p-2 hover:bg-gray-700 rounded-full transition-colors"><svg class="w-5 h-5 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg></button>
                                </form>
                            </div>
                        </td>
                    </tr>`;
        ...
        async function updateTransactionsList() {
            ...
            const url = `api_search_transactions.php?${params.toString()}`;
            
            // Update export link
            exportLink.href = `export_transactions.php?${params.toString()}`;
            ...
            try {
                ...
                if (data.success) {
                    ...
                    tableBody.innerHTML = `<tr><td colspan="6" class="text-center p-10 text-red-400">Errore: ${data.message}</td></tr>`;
                }
            } catch (error) {
                tableBody.innerHTML = `<tr><td colspan="6" class="text-center p-10 text-red-400">Errore di connessione.</td></tr>`;
            }
        }
        ...
        inputs.forEach(input => {
            input.addEventListener('input', () => {
                ...
                debounceTimer = setTimeout(updateTransactionsList, 350);
            });
        });
        
        // Render initial transactions passed from PHP
        renderTransactions(<?php echo json_encode($allTransactions); ?>);
    });
    ...
    <div id="import-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-lg p-6 transform scale-95 opacity-0 modal-content">
            <h2 class="text-2xl font-bold  mb-4">Importa Transazioni da File</h2>
            ...
            <form action="import_transactions.php" method="POST" enctype="multipart/form-data">
                <div class="space-y-4">
                    <div>
                        ...
                        <select name="account_id" id="import-account-id" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                            <?php foreach($userAccounts as $account): ?>
                    ...
                    <div>
                        ...
                        <select name="bank_format" id="bank-format" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    ...
                    <div>
                        ...
                        <input type="file" name="csv_file" id="csv-file" required accept=".csv" class="w-full text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-primary-600 file: hover:file:bg-primary-700">
                    </div>
                </div>
                <div class="mt-8 flex justify-end space-x-4">
                    <button type="button" onclick="closeModal('import-modal')" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg">Annulla</button>
                    <button type="submit" class="bg-primary-600 hover:bg-primary-700  font-semibold py-2 px-5 rounded-lg">Importa</button>
                </div>
            </form>
        </div>
    </div>
