    ...
    <div class="flex h-screen">
        ...
        <main class="flex-1 p-6 lg:p-10 overflow-y-auto">
            <header class="flex flex-wrap justify-between items-center gap-4 mb-8">
                <div>
                    <h1 class="text-3xl font-bold ">Statistiche: <?php echo htmlspecialchars($fund['name']); ?></h1>
                    <p class="text-gray-400 mt-1">Analisi delle spese e dei contributi del fondo.</p>
                </div>
                <a href="fund_details.php?id=<?php echo $fund_id; ?>" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-4 rounded-lg">
                    &larr; Torna al Fondo
                </a>
            </header>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <!-- Member Stats Chart -->
                <div class="bg-gray-800 rounded-2xl p-6">
                    <h2 class="text-xl font-bold  mb-4">Riepilogo Membri</h2>
