...
================================================================================
-->
<div id="toast-notification" class="fixed bottom-5 right-5 w-full max-w-xs p-4 rounded-lg shadow-lg  transition-opacity duration-300 ease-in-out opacity-0 hidden" role="alert">
