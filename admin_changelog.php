...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/99bsk1ni5mynnhu83al93ekf7jht8ol5ms2xo3qln45214ko/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
    <script>
        tailwind.config = {
            theme: {
                extend: {
...
<body class="text-gray-300">
    <div class="flex h-screen">
        ...
        <main class="flex-1 p-4 sm:p-6 lg:p-10 overflow-y-auto">
            <header class="flex justify-between items-center mb-8">
                <h1 class="text-3xl font-bold ">Gestione Changelog</h1>
                <div  class="flex gap-2" style="flex-wrap:wrap;">
                    <a href="admin.php" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-4 rounded-lg flex items-center">Indietro</a>
                    <button onclick="openChangelogModal()" class="bg-primary-600 hover:bg-primary-700  font-semibold py-2 px-4 rounded-lg">Aggiungi Aggiornamento</button>
                </div>
            </header>
    ...
    <div id="changelog-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-3xl p-6 transform scale-95 opacity-0 modal-content" style="height: -webkit-fill-available;overflow: auto;">
            <h2 id="modal-title" class="text-2xl font-bold  mb-6">Aggiungi Aggiornamento</h2>
            <form id="changelog-form">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="version" id="version" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    </div>
                    <div>
                        <label for="image_url" class="block text-sm font-medium text-gray-300 mb-1">URL Immagine (Opzionale)</label>
                        <input type="url" name="image_url" id="image_url" class="w-full bg-gray-700  rounded-lg px-3 py-2">
                    </div>
                </div>
                <div class="mt-4">
                    <label for="title" class="block text-sm font-medium text-gray-300 mb-1">Titolo</label>
                    <input type="text" name="title" id="title" required class="w-full bg-gray-700  rounded-lg px-3 py-2">
                </div>
                <div class="mt-4">
                    <label for="description" class="block text-sm font-medium text-gray-300 mb-1">Breve Descrizione</label>
                    <textarea name="description" id="description" rows="2" class="w-full bg-gray-700  rounded-lg px-3 py-2"></textarea>
                </div>
                <div class="mt-4">
                    <label for="content" class="block text-sm font-medium text-gray-300 mb-1">Contenuto Principale</label>
                    <textarea name="content" id="content" class="w-full bg-gray-700  rounded-lg px-3 py-2"></textarea>
                </div>
                <div class="mt-4">
                ...
                <div class="mt-8 flex justify-end space-x-4">
                    <button type="button" onclick="closeModal('changelog-modal')" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg">Annulla</button>
