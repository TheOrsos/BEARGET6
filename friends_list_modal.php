...
<div id="friends-list-modal-<?php echo $prefix; ?>" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
    ...
    <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-md p-6 transform scale-95 opacity-0 modal-content">
        ...
        <div class="mb-4">
            <input type="text" id="friend-search-input-<?php echo $prefix; ?>" placeholder="Cerca per nome utente..." class="w-full bg-gray-700  rounded-lg px-3 py-2 text-sm border border-gray-600 focus:ring-primary-500 focus:border-primary-500">
        </div>
        ...
        <div class="flex justify-end mt-6">
            <button type="button" class="text-gray-400 hover:" onclick="closeModal('friends-list-modal-<?php echo $prefix; ?>')">Chiudi</button>
        </div>
    </div>
</div>
