        ...
        <main class="flex-1 p-6 lg:p-10 overflow-y-auto flex flex-col">
            <form action="update_note.php" method="POST" id="note-form" class="flex flex-col flex-grow">
                ...
                <header class="flex justify-between items-center mb-6 flex-shrink-0">
                    <input type="text" name="title" value="<?php echo htmlspecialchars($note['title']); ?>" class="text-3xl font-bold  bg-transparent border-0 border-b-2 border-gray-700 focus:ring-0 focus:border-primary-500 w-full mr-4">
                    <div class="flex items-center space-x-2">
                        <button type="submit" class="bg-primary-600 hover:bg-primary-700  font-semibold py-2 px-5 rounded-lg">Salva</button>
                        <a href="notes.php" class="bg-gray-600 hover:bg-gray-700  font-semibold py-2 px-5 rounded-lg">Indietro</a>
                    </div>
                </header>
                        ...
                        <div class="flex-grow bg-gray-800 rounded-lg p-4 overflow-y-auto">
                            <div id="todolist-container" class="space-y-2">
                                ...
                                <div class="flex items-center bg-gray-900 p-2 rounded-lg todolist-item">
                                    ...
                                    <input type="text" value="<?php echo htmlspecialchars($item['task'] ?? ''); ?>" class="flex-grow bg-transparent  border-0 focus:ring-0 mx-2 <?php if($is_completed) echo 'line-through text-gray-500'; ?>">
